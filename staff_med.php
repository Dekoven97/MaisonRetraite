...
<!--CSS-->
<link rel="stylesheet" href="css/staff_med.css">
<!--website icon-->
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="staff_med.php">Staff Medical<span class="sr-only">(current)</span></a>
      </li>
...
<div class="ti">Staff Medical</div> <br>
