...
<link rel="stylesheet" href="css/admRes.css">
<!--website icon-->
...
<div class="ti">Information sur les Résident</div> <br>
...
$sql = "SELECT Patient.*, Responsables.*
FROM Patient
INNER JOIN Responsables
ON (Patient.Patient_ID = Responsables.Responsable_ID);";
...
while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
  ...
  <tr>
      ...
      <td>'.$row['Telephone'].'</td>
      <td><a href="detAdm.php?id='.$id.'"><i class="fas fa-info-circle"></a></i></td>
    </tr>
...
<div class="container-fluid">
<div class="ti">Nombre de resident </div> <br>
...
$sql = "SELECT COUNT (Nom) AS NResident from Patient";
...
$sql = "SELECT COUNT (Sexe) AS NResident from Patient where Sexe='F'";
...
$sql = "SELECT COUNT (Sexe) AS NResident from Patient where Sexe='M'";
