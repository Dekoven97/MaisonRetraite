...
ON (Patient.Patient_ID = Responsables.Responsable_ID) JOIN Maladie ON (Patient.Patient_ID = Maladie.Maladie_ID)";
...
while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
  ...
  <tr>
      ...
      <td>'.$row['Telephone'].'</td>
      <td><a href="det.php?id='.$id.'"><i class="fas fa-info-circle"></a></i></td>
    </tr>
