...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="admRes.php">Résident</a>
      </li>
    


      <li class="nav-item active">
        <a class="nav-link" href="admRes.php">Recherche<span class="sr-only">(current)</span></a>
      </li>
...
$search_value=$_POST["search"];
        ...
        $sql="select * from Patient where Nom like '%$search_value%' or Prenom like '%$search_value%' ";
